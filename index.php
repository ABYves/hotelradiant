...
<head>
    ...
    <link href="Hotel/CSS/main.css" type="text/css" rel="stylesheet">
...
<body>
    <nav class="nav-bar top-nav flex-row"><!-- Contains the navigations bar-->
        <ul class="nav-list">
            ...
            <li class="nav-list-item"><a class="nav-link" href="Hotel/HTML/eat.php">Eat</a></li>
            <li class="nav-list-item"><a class="nav-link" href="Hotel/HTML/sleep.php">Sleep</a></li>
            <li class="nav-list-item"><a class="nav-link" href="Hotel/HTML/meet.php">Meetings</a></li>
            <li class="nav-list-item"><a class="nav-link" href="Hotel/HTML/contact.php">Contact</a></li>
            <li class="nav-list-item"><a class="nav-link" href="Shop\HTML\index.php">shop</a></li>
        </ul>
    </nav>
    <div id="top-section" >
        <img src="Hotel/images/bright.jpg" alt="Image of a nice looking bedroom" title="Radiant Ochre bedroom" class="top-image">
    ...
    <div class="other-services grid-column">
        <img  src="Hotel/images/Outdoor-Catering.jpg" alt="A beautiful outside catering event" title="Outside catering" class="grid-image-full">
        ...
        <img src="Hotel/images/gym2.jpg" alt="our gym" title="Gym" class="grid-image-full">
        <img src="Hotel/images/kidspark2.jpg" alt="our gym" title="Gym" class="grid-image-full">
        <div class="other-services-item center-text">
            <h2>Kids Park</h2>
        ...
        <div id="testimonials-container" class="flex-column">
            ...
            <img class="testimonial-image" src="Hotel/images/woman.jpg" alt="One of our clients picture">
    ...
    <div id="contact-container" class="flex-column">
        ...
        <div class="contact-content-container" style="width:100%">
            ...
            <div class="flex-column flex-column-center">
                ...
                <form action="Hotel/HTML/message.php" method="post">
